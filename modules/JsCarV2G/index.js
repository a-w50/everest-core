...
function JavaStartedDeferred(mqtt_base_path, module_name, mod) {
  ...
  this.promise = new Promise((resolve, reject) => {
    ...
    const args = [
      ...
      mqttServerAddress, mqttServerPort, mqtt_base_path, mod.payment, mod.energymode,
    ];
...
function start_v2g(mod, args) {
    ...
    default:
        // start java process
        mod.java_started = new JavaStartedDeferred(mod.config.impl.main.mqtt_base_path, mod.info.printable_identifier, mod);
