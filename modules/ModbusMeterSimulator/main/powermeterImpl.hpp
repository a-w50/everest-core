...
public:
    ...
    powermeterImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<ModbusMeterSimulator>& mod, Conf& config) :
...
private:
    const Everest::PtrContainer<ModbusMeterSimulator>& mod;
    const Conf& config;
